            ...
            <form action="{{route('products.store')}}" method="POST" enctype="multipart/form-data" id="addproduct">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="regularprice" id="regularprice" value="{{ old('regularprice') }}">
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="saleprice" id="saleprice" value="{{ old('regularprice') }}">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <textarea class="ckeditor form-control" name="description" id="" cols="30" rows="10">{{ old('description') }}</textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-6">
                        <label for="">Stock (Optional)</label>
                        <input type="number" class="form-control" name="stock" min="1" value="{{ old('stock') }}">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="">Product Size</label>
                    <select class="form-control" name="product_sizes_id">
                        <option value="{{ old('stock') }}">--Select--</option>
               ...
               <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="tags" placeholder="tag1, tag3, tag3" value="{{ old('tags') }}"/>
