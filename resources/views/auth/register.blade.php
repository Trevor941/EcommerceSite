            ...
            <div class="col-lg-7">
                <div class="p-5">
                    ...
                    <form class="user" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            <input id="phone" type="text" class="form-control form-control-user @error('phone') is-invalid @enderror" placeholder="Cell Number" name="phone" value="{{ old('phone') }}" required autocomplete="phone">
