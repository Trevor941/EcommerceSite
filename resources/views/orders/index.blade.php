...
<div class="row pl-3 pr-3 pb-3 justify-content-between">
    ...
    <div>
        <form action="{{route('orders.index')}}" method="GET" class="form-inline">
            ...
            <div class="form-group mr-1">
                    <input type="text" id="search" name="firstname" value="{{request()->query('firstname')}}" placeholder="Customer Firstname" class="form-control typeahead" />
            </div>
            <div class="form-group">
                ...
                <tbody>
                    @foreach ($orders as $order)
                         <tr>
                            ...
                            <td>
                              <a href="#">(#{{$order->orderno}}) | {{$order->firstname}} {{$order->lastname}}</a>  
                            </td>
                            <td>
